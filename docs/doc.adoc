...
The memories are described in a device agnostic manner. It is up to the synthesizer to map onboard memory to the instantiated  memories. This can lead to excesive on-board RAM usage because the synthesizer is not able to create true dual-port RAM.
